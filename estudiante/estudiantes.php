                ...
                <div class="row">
					...
					<div class="board">
						...
						<div class="number">
                            ...
                            <a href="estudiantes.php"><div><button  type="submit" class="btn btn-secondary"><i class="fas fa-user-shield fa-4x"></i></button></div> </a>
						</div>
					...
					<div class="board">
						...
						<div class="number">
                            ...
                            <a href="../docente/docentes.php"><div><button  type="submit" class="btn btn-secondary"><i class="fa fa-user fa-4x"></i></button></div> </a>
						</div>
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="exampleInputEmail2" placeholder="Ingresa el doc del alumno" name="doc">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Expedicion</label>
                                                <input type="text" class="form-control" id="exampleInputEmail2" name="exp" placeholder="Lugar de expedicion">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Fecha de nacimiento</label>
                                                <input type="date" class="form-control" id="exampleInputEmail2" placeholder="jane.doe@example.com" name="fecha_nac">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Grado</label>
                                                <input type="number" class="form-control" id="exampleInputEmail2" placeholder="ingresa el grado" name="grado">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Documento del acudiente</label>
                                                <input type="number" class="form-control" id="exampleInputEmail2" placeholder="Ingrese el documento del acudiente" name="doc_acu">
                                            </div>
                                         </div>
                        ...
                        <div class="panel-body panel">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
                                            $query="SELECT * FROM laescuela.estudiante";
                                            ...
                                            <td><?php echo $row['documento_est']?></td>
                                            <td><?php echo $row['grado']?></td>
                                            <td>
                                            <a href="../estudiante/editar.php?id=<?php echo $row['cod_estudiante'] ?>" class="btn btn-warning">
                                            <i class="fas fa-user-edit"></i>
                                            </a>

                                            <a href="../estudiante/borrar.php?id=<?php echo $row['cod_estudiante'] ?>" class="btn btn-danger">
