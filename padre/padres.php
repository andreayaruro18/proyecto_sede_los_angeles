    ...
    <div id="wrapper">
		...
		<div id="page-wrapper">
		  <div class="header"> 
				...
				<li><a href="./padres.php"</a>Padres</li>
				<li class="active"></li>
				</ol> 
                ...
                <div class="row">
					...
					<div class="board">
						...
						<div class="number">
                            ...
                            <a href="padres.php"><div><button  type="submit" class="btn btn-secondary"><i class="fas fa-user-tie fa-4x"></i></button></div> </a>
						</div>
                                        ...
                                        <div class="col-md-6">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="exampleInputEmail2" placeholder="Ingresa el tipo de documento" name="Tdoc">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Documento</label>
                                                <input type="number" class="form-control" id="exampleInputEmail2" placeholder="Ingresa el doc del acudiente" name="doc">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                         ...
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="date" class="form-control" id="exampleInputEmail2" placeholder="" name="fecha_nac">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="exampleInputEmail2">Parentesco</label>
                                                <input type="text" class="form-control" id="exampleInputEmail2" placeholder="ingresa parentesco" name="parentesco">
                                            </div>
                                         </div>
                        ...
                        <div class="panel-body panel">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php 
                                            $query="SELECT * FROM laescuela.padre";
                                            ...
                                            <td><?php echo $row['documento_pad']?></td>
                                            <td><?php echo $row['parentesco']?></td>
                                            <td>
                                            <a href="../padre/editarP.php?id=<?php echo $row['cod_padre'] ?>" class="btn btn-warning">
                                            <i class="fas fa-user-edit"></i>
                                            </a>

                                            <a href="../padre/borrar.php?id=<?php echo $row['cod_padre'] ?>" class="btn btn-danger">
